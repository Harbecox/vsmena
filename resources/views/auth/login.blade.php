...
@section("content")
    ...
    <div class="container login_form_container d-flex align-items-center justify-content-center">
        ...
        <div class="d-flex justify-content-center align-items-center h-100">
            <form method="POST" action="/login" class="login_form" data-class="EmailCheckRequest">
                @csrf
                        ...
                        <svg width="24.000000" height="24.000000" viewBox="0 0 24 24" fill="none"
                            ...
                            <defs>
                                <clipPath id="clip11_87">
                                    <rect id="Frame 1437255009" rx="3.000000" width="22.000000" height="22.000000"
                                          transform="translate(1.000000 1.000000)" fill="white" fill-opacity="0"></rect>
                                </clipPath>
                            </defs>
                            <g class="check">
                                <path id="Vector" d="M15.52 10L11.17 14.35L9 12.17" stroke="#249104"
                                      stroke-opacity="1.000000" stroke-width="2.000000" stroke-linejoin="round"
                                      stroke-linecap="round"></path>
                            </g>
                            <rect id="Frame 1437255009" rx="3.000000" width="22.000000" height="22.000000"
                                  transform="translate(1.000000 1.000000)" stroke="#249104" stroke-opacity="1.000000"
                                  stroke-width="2.000000"></rect>
                        </svg>
