...
@section("content")
    ...
    <div class="container login_form_container d-flex align-items-center justify-content-center">
        ...
        <div class="d-flex justify-content-center align-items-center h-100">
            <form method="POST" action="{{ route('password.email') }}" class="login_form" data-class="PasswordResetRequest">
                @csrf
                ...
                <button class="btn btn-success w-100 mt-30 text-white">Отправить код для восстановления</button>
